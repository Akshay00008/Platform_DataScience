...
def update_token_usage_in_mongo(chatbot_id: str, tokens_used: int):
    ...
    try:
        ...
        # Step 1: Check if the current usage exceeds the MAX_TOKEN_LIMIT
        ...
        # Step 2: Update the token usage if the limit is not reached
        ...
        # Step 3: Perform the update operation (upsert to create a new document if none exists)
