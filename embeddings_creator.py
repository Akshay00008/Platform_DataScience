...
def embeddings_from_website_content(json_data,  chatbot_id, version_id):
    ...
    # Save index and metadata
    index_dir  = "C:\\Users\\hp\\Desktop\\Platform_16-05-2025\\faiss_indexes" #"/home/bramhesh_srivastav/Platform_DataScience/faiss_indexes"  # Directory where indexes will be saved
    os.makedirs(index_dir, exist_ok=True)
